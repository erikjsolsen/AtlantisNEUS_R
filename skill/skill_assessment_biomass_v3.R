library(plyr)
modelBiomassTable = read.table("E:\\Atlantis Skill Assessment\\Modeled_Biomass.csv",sep=",",header=TRUE)
observedBiomassTable = read.table("E:\\Atlantis Skill Assessment\\Observed_Biomass.csv",sep=",",na.strings = "NA",header=TRUE)
...
write.table(MEF_tuning_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv",sep=",",quote=FALSE,append=FALSE)
write.table(MEF_prediction_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv", sep=",",quote=FALSE,append=TRUE)
...
write.table(AE_tuning_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv",sep=",",quote=FALSE,append=TRUE)
write.table(AE_prediction_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv", sep=",",quote=FALSE,append=TRUE)
...
write.table(AAE_tuning_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv",sep=",",quote=FALSE,append=TRUE)
write.table(AAE_prediction_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv", sep=",",quote=FALSE,append=TRUE)
...
write.table(RMSE_tuning_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv",sep=",",quote=FALSE,append=TRUE)
write.table(RMSE_prediction_table,file="E:\\Atlantis Skill Assessment\\v3 Outputs\\Skill_table.csv", sep=",",quote=FALSE,append=TRUE)

write.table(combined.table,file="E:\\Atlantis Skill Assessment\\Combined_Biomass_Skill_table.csv",sep=",",quote=FALSE)